...
class LeaveListScreen extends StatefulWidget {
  ...
  const LeaveListScreen({Key? key, required this.updateBadge}) : super(key: key);
  @override
...
class _LeaveListScreenState extends State<LeaveListScreen> {
  ...
  popup_comfirm(BuildContext context, List rs) {
    showDialog(
        context: context,
        builder: (_) {
          return ConfirmDialog(
            ...
            onConfirmTap: (String value) {
              // Add your confirm logic here, you can use 'value' if needed
              Navigator.of(context).pop();
            },
            cidSub: rs.isNotEmpty ? rs[0]['cid'].toString() : '',
            filesAll: _files,
            select1: select1,
            select2: select2,
            select3: select3,
            ...
            fullName: _itemMember.isNotEmpty ? (_itemMember[0].FULLNAME ?? '') : '',
          );
        });
  }
