class ItemsSummaryToDay_Outside {
  final String ID;
  final String CID;
  ...
  factory ItemsSummaryToDay_Outside.fromJson(Map<String, dynamic> json) {
    return ItemsSummaryToDay_Outside(
      ID: json['id'],
      CID: json['cid'],
