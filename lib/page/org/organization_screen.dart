...
class _OrganizationScreenState extends State<OrganizationScreen> {
  ...
  _getLocation() {
    _location.onLocationChanged.listen((LocationData currentLocation) {
      setState(() {
        lat = currentLocation.latitude != null ? currentLocation.latitude!.toDouble() : 0.0;
        lng = currentLocation.longitude != null ? currentLocation.longitude!.toDouble() : 0.0;
      });
    });
  }
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                    ...
                                    invite: "000000000",
                                    action: true,
                                    history: 'false', // Provide appropriate value
                                    noti: 'false', // Provide appropriate value
                                    refresh: () {}, // Provide appropriate callback
                                    logout: 'false', // Provide appropriate value
                                    ot: 'false', // Provide appropriate value
                                    time_status: 'false', // Provide appropriate value
                                    leave_cancel_status: 'false', // Provide appropriate value
                                  ),
                                ),
                              );
                            },
