...
class SharedCashe {
  static saveItemsMemberList({required List<dynamic> item}) async {
  ...
  static getItemsWay({required String name}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<bool> getItemsBoolWay({required String key}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static savaItemsString({required String key, required String valString}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(key, valString);
    print(prefs.getString(key));
  }

  static savaItemsBool({required String key, required bool valBool}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
