...
import 'package:ismart_login/src/features/front/presentation/pages/model/itemMemberRelationship.dart';
...
class MemberRelationshipFuture {
  ...
  Future<List<ItemsMemberRelationship>> apiGetMemberRelationshipList(
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load member relationships');
    }
  }
}
