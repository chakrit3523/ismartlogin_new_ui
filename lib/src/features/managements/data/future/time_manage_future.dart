...
import 'package:ismart_login/src/features/managements/presentation/pages/model/itemTimeManage.dart';
...
class TimeManageFuture {
  ...
  Future<List<ItemsTimeManage>> apiGetTimeManageList(Map jsonMap) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to load time manage list');
    }
  }
  ...
  Future<List<ItemsTimeManage>> apiGetTypesManageList(Map jsonMap) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
      throw Exception('Failed to load types manage list');
    }
  }
  ...
  Future<List<ItemsTimeManagePostUpdate>> apiPostTimeManageList(
    ...
    if (response.statusCode == 200) {
      ...
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
      throw Exception('Failed to post time manage list');
    }
  }
}
