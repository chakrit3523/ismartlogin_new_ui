...
import 'package:ismart_login/src/features/managements/presentation/pages/org_departmentdetail_screen.dart';
...
class OrgDepartmentManage extends StatefulWidget {
  final String org_id;
  const OrgDepartmentManage({super.key, required this.org_id});
  @override
