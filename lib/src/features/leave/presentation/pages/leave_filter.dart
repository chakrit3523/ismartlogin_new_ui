...
class LeaveFilterScreen extends StatefulWidget {
  ...
  const LeaveFilterScreen({
    required Key key,
    required this.statusDataTmp,
    required this.typesDataTmp,
    required this.setDataFilterLeaveData,
    required this.dropdownValueStartMonthTmp,
    required this.dropdownValueStartYearTmp,
    required this.dropdownValueEndMonthTmp,
    required this.dropdownValueEndYearTmp,
  }) : super(key: key);
  @override
                ...
                children: [
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        blocSetState(() {
                          dropdownValueStartMonth = newValue ?? "เลือกเดือน";
                          if (dropdownValueStartMonth != "เลือกเดือน") {
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        blocSetState(() {
                          dropdownValueStartYear = newValue ?? "เลือกปี";
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        blocSetState(() {
                          dropdownValueEndMonth = newValue ?? "เลือกเดือน";
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        blocSetState(() {
                          dropdownValueEndYear = newValue ?? "เลือกปี";
