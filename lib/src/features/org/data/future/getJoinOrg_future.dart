...
import 'package:ismart_login/src/features/managements/presentation/pages/model/itemMemberManage.dart';
import 'package:ismart_login/src/features/org/presentation/pages/model/getorgresult.dart';
import 'package:ismart_login/src/features/org/presentation/pages/model/itemSwitchOrg.dart';
import 'package:ismart_login/src/features/org/presentation/pages/model/newmemberorglist.dart';
...
class GetOrgFuture {
  ...
  Future<List<ItemsMemberManage>> apiGetMemberOrgList(Map jsonMap) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
      throw Exception('Failed to load member organization list');
    }
  }
  ...
  Future<List<ItemsResultUpdateNewMember>> apiUpdateNewMemberOrgList(
    ...
    if (response.statusCode == 200) {
      ...
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
      throw Exception('Failed to update new member organization list');
    }
  }
  ...
  Future<List<ItemsSwitchOrg>> apiUpdateSwitchOrgList(Map jsonMap) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
      throw Exception('Failed to update switch organization list');
    }
  }
}
