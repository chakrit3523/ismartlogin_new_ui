...
import 'package:ismart_login/src/features/org/presentation/pages/future/getJoinOrg_future.dart';
import 'package:ismart_login/src/features/org/presentation/pages/join_member_screen.dart';
...
class _OrganizationJoinDetailScreenState
  ...
  // FToast fToast;
  late ItemsGetOrgList _itemsGetOrgList;
//-----
  @override
  void initState() {
    EasyLoading.dismiss();
