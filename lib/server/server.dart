...
class Server {
  ...
  // V2 API endpoints - 2-Step Synchronous Upload
  String get uploadImageV2 => _baseUrl + "attend/uploadImageV2";
  String get attendStartV2 => _baseUrl + "attend/attendStartV2";
  String get attendEndV2 => _baseUrl + "attend/attendEndV2";
  ...
  String postupdateCancelStatusLeave =
      _baseUrl + 'manage/updateCancelStatusLeave';
